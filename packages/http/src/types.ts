...
export const ErrorCodes = {
  ERR_DEF: 'MR_ERR',
  ER_NO_MOCK_FOUND: 'MR_ERR_NO_MOCK',
  ERR_PENDING_SCOPE: 'MR_ERR_HTTP_PENDING_SCOPE',
  ERR_INVALID_MOCK_CONFIG: 'MR_ERR_HTTP_INVALID_MOCK_CONFIG',
  ERR_INVALID_MOCK_FILE: 'MR_ERR_HTTP_INVALID_MOCK_FILE',
  ERR_INVALID_RESPONSE_DEFINITION: 'MR_ERR_HTTP_INVALID_RESPONSE_DEFINITION'
}
